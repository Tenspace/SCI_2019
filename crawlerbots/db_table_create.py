...
facebook = '''CREATE TABLE `facebook_score` (
        ...
        `expression_negative` INT(11) NULL DEFAULT NULL,
        `expression_positive` INT(11) NULL DEFAULT NULL,
        `friends_all` INT(11) NULL DEFAULT NULL,
        `friends_residence` INT(11) NULL DEFAULT NULL,
        `friends_company` INT(11) NULL DEFAULT NULL,
        `friends_univ` INT(11) NULL DEFAULT NULL,
        `friends_highschool` INT(11) NULL DEFAULT NULL,
        `friends_native` INT(11) NULL DEFAULT NULL,
        `take_news` INT(11) NULL DEFAULT NULL,
        `post_interest` INT(11) NULL DEFAULT NULL,
        `post_up` INT(11) NULL DEFAULT NULL,
        `feeling_cnt` INT(11) NULL DEFAULT NULL,
        `following_cnt` INT(11) NULL DEFAULT NULL,
        `follower_cnt` INT(11) NULL DEFAULT NULL,
        `like_all_cnt` INT(11) NULL DEFAULT NULL,
        `like_movie_cnt` INT(11) NULL DEFAULT NULL,
        `like_tv_cnt` INT(11) NULL DEFAULT NULL,
        `like_music_cnt` INT(11) NULL DEFAULT NULL,
        `like_book_cnt` INT(11) NULL DEFAULT NULL,
        `like_sports_cnt` INT(11) NULL DEFAULT NULL,
        `like_athlete_cnt` INT(11) NULL DEFAULT NULL,
        `like_restaurant_cnt` INT(11) NULL DEFAULT NULL,
        `like_appgame_cnt` INT(11) NULL DEFAULT NULL,
        `check_in` INT(11) NULL DEFAULT NULL,
        `event` INT(11) NULL DEFAULT NULL,
        `review` INT(11) NULL DEFAULT NULL,
        `like_cnt` INT(11) NULL DEFAULT NULL,
        `comment_cnt` INT(11) NULL DEFAULT NULL,
        `share_cnt` INT(11) NULL DEFAULT NULL,
        `place_cnt` INT(11) NULL DEFAULT NULL,
        `place_add` INT(11) NULL DEFAULT NULL,
        `post_cnt` INT(11) NULL DEFAULT NULL,
        `photo_of_oneself_cnt` INT(11) NULL DEFAULT NULL,
        `photo_cnt` INT(11) NULL DEFAULT NULL,
        `album_cnt` INT(11) NULL DEFAULT NULL,
        `album_category_cnt` INT(11) NULL DEFAULT NULL,
        `video_tag_oneself_cnt` INT(11) NULL DEFAULT NULL,
        `video_cnt` INT(11) NULL DEFAULT NULL,
        `operation_year_period` INT(11) NULL DEFAULT NULL,
        `friends_continuous_exchange` INT(11) NULL DEFAULT NULL,
        `friends_rating_index` INT(11) NULL DEFAULT NULL,
        `friends_correlation_score` INT(11) NULL DEFAULT NULL,
        `contents_regular` INT(11) NULL DEFAULT NULL,
        PRIMARY KEY (`no_index`)
    ) ENGINE=InnoDB DEFAULT CHARSET=utf8
    ;'''

kakaoStory = '''CREATE TABLE `kakaoStory_score` (
        `no_index` INT(11) NOT NULL AUTO_INCREMENT,
        `insertedTime` TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP,
        `origin_ph` VARCHAR(255) NULL DEFAULT NULL,
        `platform` VARCHAR(255) NULL DEFAULT NULL,
...
instagram = '''CREATE TABLE `instagram_score` (
        `no_index` INT(11) NOT NULL AUTO_INCREMENT,
        `insertedTime` TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP,
        `origin_ph` VARCHAR(255) NULL DEFAULT NULL,
        `platform` VARCHAR(255) NULL DEFAULT NULL,
...
post = '''CREATE TABLE `post` (
        ...
        `post_reply` INT(11) NULL DEFAULT NULL,
        `post_share` INT(11) NULL DEFAULT NULL,
        `post_up` INT(11) NULL DEFAULT NULL,
...
mismatch = '''CREATE TABLE `mismatch` (
        `no_index` INT(11) NOT NULL AUTO_INCREMENT,
        `origin_ph` VARCHAR(255) NULL DEFAULT NULL,
        `platform` VARCHAR(255) NULL DEFAULT NULL,
...
# cursor.execute(facebook)
# cursor.execute(kakaoStory)
# cursor.execute(instagram)
# cursor.execute(post)
