...
class DatabaseConnection:
    ...
    # INSERT facebook
    def facebook_insert(self, origin_ph, platform, page_id, username, gender, phone_number, birthday, company1, company2, company3,
        ...
        try:
            ...
            self.cursor.execute(insert_command, (origin_ph, platform, page_id, username, gender, phone_number, birthday, address1, address2,
    ...
    # INSERT insta story
    def insta_insert(self, origin_ph, platform, page_id, username, expression_negative, expression_positive,
                     following_cnt, follower_cnt, post_cnt, like_cnt, place_add, photo_cnt, video_cnt,
        ...
        try:
            ...
            print('insert ok', insert_command)
            self.cursor.execute(insert_command, (origin_ph, platform, page_id, username, None, None, None, None, None,
                                                 None, None, None, None, None, None, None, None, None,
                                                 expression_negative, expression_positive, None, None, None, None, None,
                                                 None, None, None, None, None, following_cnt, follower_cnt, None,
                                                 None, None, None, None, None, None, None, None, None, None, None,
                                                 like_cnt, None, None, None, place_add, post_cnt, None,
